...
import { Trophy, TrendingUp, TrendingDown, Minus, ExternalLink, Loader2 } from "lucide-react";
...
export default function LeaderboardPage() {
    ...
    const { data: leaderboardData, isLoading } = useQuery({
        ...
        queryFn: () => fetchLeaderboard("all-time"),
    });
    ...
    const runnersList = leaderboardData || [];
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                            ...
                            {runnersList.map((portfolio: any, index: number) => {
                                const rank = index + 1;
                                return (
