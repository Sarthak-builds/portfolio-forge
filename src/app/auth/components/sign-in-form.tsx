    ...
    <div className="w-full transition-all animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <FormControl>
                  <div className="relative group">
                    ...
                    <Input 
                      ...
                      {...field} 
                      disabled={isLoading}
                      className="pl-10 h-12 bg-zinc-900/50 border-zinc-800 rounded-xl focus-visible:ring-emerald-500/50 focus-visible:border-emerald-500/50 transition-all font-medium text-zinc-200"
                    />
                  </div>
                </FormControl>
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full h-12 mt-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold transition-all shadow-lg shadow-emerald-900/20 active:scale-[0.98] disabled:opacity-70"
          >
            {isLoading ? (
      ...
      <div className="mt-8 text-center">
        <p className="text-sm font-medium text-zinc-500">
          ...
          <Link href="/auth/sign-up" className="text-emerald-400 hover:text-emerald-300 font-bold transition-colors underline underline-offset-4">
            Create account
          </Link>
        </p>
      </div>
